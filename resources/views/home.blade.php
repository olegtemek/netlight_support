  ...
  <div class="col-sm">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-text">Кол-во доступов к сайтам : <span style="display: inline" class="info-box-number">{{ $sites }}</span> </span>
        <a href="{{ route('sites.export') }}" class="btn btn-success">Экспорт данных в Excel</a>
      </div>
      <!-- /.info-box-content -->
    </div>
    <!-- /.info-box -->
